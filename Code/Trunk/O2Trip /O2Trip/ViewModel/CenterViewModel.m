...
@implementation CenterViewModel
...
-(void) fetchPublicWeiBo
{
    ...
    [NetRequestClass NetRequestGETWithRequestURL:REQUESTURL WithParameter:parameter WithReturnValeuBlock:^(id returnValue) {
...
-(void)fetchValueSuccessWithDic: (NSDictionary *) returnValue
{
    ...
    for (int i = 0; i < statuses.count; i ++) {
        CenterModel *publicModel = [[CenterModel alloc] init];
       /**
        //设置时间
...
-(void) weiboDetailWithPublicModel: CenterModel *) publicModel WithViewController:(UIViewController *)superController
{
